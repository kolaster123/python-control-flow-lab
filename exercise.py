...
def weather_advice():
    ...
    if is_cold.lower() == 'yes' and is_raining.lower() == 'yes':
        print("Wear a waterproof coat.")
    elif is_cold.lower() == 'yes' and is_raining.lower() == 'no':
        print("Wear a warm coat.")
    elif is_cold.lower() == 'no' and is_raining.lower() == 'yes':
        print("Carry an umbrella.")
    elif is_cold.lower() == 'no' and is_raining.lower() == 'no':
